...
- **[MASTER_PROMPT.md](MASTER_PROMPT.md)** — Мастер-промпт для активации режима Senior AI Developer
  - AI сам предлагает команды
  - Подключает MCP автоматически
  - Использует агентов из базы знаний
  - Ведёт разработку как опытный разработчик
